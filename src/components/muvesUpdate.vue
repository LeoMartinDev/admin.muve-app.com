<template>
  <b-modal id="muvesUpdate" title="Update a muve" @hidden="onHidden" @cancel="onCancel" @ok="onOk" :visible="true">
  ...
  export default {
    ...
    methods: {
      ...
      onOk() {
        ...
        this.updateMuve({id: this.$route.params.id, muve: this.form })
